...
urlpatterns = [
    ...
    path('cars/<int:state_id>/', views.states_detail, name='detail'),
    path('cars/create/', views.StateCreate.as_view(), name='states_create'),
    path('cars/<int:pk>/update/', views.StateUpdate.as_view(), name='states_update'),
    path('cars/<int:pk>/delete/', views.StateDelete.as_view(), name='states_delete'),
    path('cars/<int:state_id>/add_updates/', views.add_updates, name='add_updates'),
